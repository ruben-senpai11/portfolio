        ...
        {/* <div className=""> */}
          <div className="description flex flex-col gap-8 justify-center align-center ">
            <h1 className="flex flex-col " >
              ...
              <span className="max-w-[500px] border-solid text-[20px] pt-4" >{(h('description'))}<span className="font-mono bg-purple-400 m-1 p-1 bg-text-colored " >{(h('description-colored'))}</span>. </span>
            </h1>
            <p>
            {(h('text'))} 
