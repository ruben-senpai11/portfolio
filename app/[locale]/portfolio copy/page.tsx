            ...
            <div className="flex flex-col gap-12 m-autod ">
              ...
              <div className="flex flex-col gap-8">
                ...
                <div className="projects-grid ">
                  <Project image={interview} title="Projects Filter" stack={["Vue.js", "TypeScript", "Bootstrap", "GSAP"]} description="I figured out to master Vue.js at a new level of proficency. I'm building so an app who includes as well innovative design & structure as advanced tests." link="https://ruben-interview.vercel.app/" />
              ...
              <div className="flex flex-col gap-8">
                ...
                <div className="projects-grid ">
                  <Project image={navbar} title="Responsive Navbar" stack={["HTML & CSS", "JavaScript"]} link="https://github.com/ruben-senpai11/Reponsive-Navbar" description="Fully Responsive Navbar built from scratch. If creating Navbar stucks, here is a built from scratch and easy to understand responsive navbar who may help you stand out." />
